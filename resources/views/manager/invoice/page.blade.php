              ...
              <tr role="row" class="odd">
                ...
                <td style="display: none;" class="d-block-s">
                  @if(\App\Http\Controllers\managerController::managerAccessLevel(68))
                   <a href="/manager/invoice/user/{{$invoice["id"]}}" data-toggle="tooltip" data-placement="top" data-original-title="فرم های پرشده" class="btn btn-success"><i class="fa fa-eye"></i></a>
                   <a href="/manager/invoice/edit/{{$invoice['id']}}" data-toggle="tooltip" data-placement="top" data-original-title="ویرایش" class="btn btn-success mt-2 mb-2"><i class="fa fa-edit"></i></a>
                  @endif
