      ...
      <div  class="card-box table-responsive">
        <div class="m-t-0 m-b-30">
          ...
          @if(\App\Http\Controllers\managerController::managerAccessLevel(22))
            <a href="/manager/form/add" class="btn btn-success btn-trans waves-effect w-md waves-success m-b-5 float-right">افزودن فرم</a>
          @endif
        </div>
              ...
              @foreach($forms as $form)
                <tr role="row" class="odd">
                  ...
                  <td style="display: none;" class="d-block-s">
                    ...
                    @if(\App\Http\Controllers\managerController::managerAccessLevel(22))
                      <a href="/manager/form/edit/{{$form['id']}}" data-toggle="tooltip" data-original-title="ویرایش" class="btn btn-warning"><i class="fa fa-pencil"></i></a>
                    @endif
