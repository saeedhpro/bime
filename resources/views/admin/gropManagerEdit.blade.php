                        ...
                        <div class="row">
                            ...
                            <div class=" mb-3  col-lg-6 col-xl-4">
                                <label for="checkbox6c{{$val["id"]}}">
                                    <input id="checkbox6c{{$val["id"]}}" @if($manager["access"]!=null and $manager["access"]!="null") @foreach(json_decode($manager["access"], 1) as $item => $access) @if($access == $val["id"]) checked  @endif  @endforeach @endif value="{{$val["id"]}}" name="access[]" type="checkbox">
