            ...
            <div class="col-9 mb-3">
                <div class="card-box ">
                    <div class="m-t-0 m-b-30">
                        ...
                        <h4 class="header-title d-inline-block ">تنظیمات سیستم دانیال</h4>
                    </div>


                    <form class="form-horizontal form" method="post"  action="/admin/setting" role="form" enctype="multipart/form-data" data-parsley-validate novalidate>
                       @csrf
                        ...
                        <div class="row">
                            <div class="col-lg-6 mt-3">
                                ...
                                <input value="{{$mobile_contactu["input1"]}}" required name="mobile_contactu" type="text" class="form-control"
                                       id="inputEmail31" placeholder="شماره تلفن را وارد کنید">

                            </div>
                            <div class="col-lg-6 mt-3">
                                <label for="inputEmail31">آدرس تماس با ما</label>

                                <input value="{{$text_contactu["input3"]}}" required name="text_contactu" type="text" class="form-control"
                                       id="inputEmail31" placeholder="آدرس را وارد کنید">
