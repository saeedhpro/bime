      ...
      <div class="row">
          <div class="col-12 mb-3">
              <div class="card-box ">
                  ...
                  <form class="form-horizontal form" method="post" action="/admin/menu/edit/{{$menu["id"]}}" role="form" enctype="multipart/form-data" data-parsley-validate novalidate>
      ...
      $('select[name="grop"]').change(function() {
        $.ajax('/admin/menu/add/gropUser', {
          ...
          success: function(data1){
            ...
            $.each(jQuery.parseJSON(data1), function(index, value){
