      ...
      <div class="row">
          <div class="col-12 mb-3">
              <div class="card-box ">
                  ...
                  <form class="form-horizontal form" method="post" action="/admin/menu/add" role="form" enctype="multipart/form-data" data-parsley-validate novalidate>
                  ...
                  <div class="row">
                      ...
                      <div class="form-group row">
                          ...
                          <div class="col-sm-8">
                                  ...
                                  <option selected="" disabled="disabled">انتخاب مجموعه</option>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <select name="gropUser[]" class="form-control select2 select2-multiple select2-hidden-accessible" multiple="multiple" data-placeholder="انتخاب گروه کاربری مجموعه" tabindex="-1" aria-hidden="true" required></select>
                        </div>
                      </div>
      ...
      $.ajax('/admin/menu/add/gropUser',
          {
              ...
              , success: function (data1) {
                  ...
                  $.each(data, function( index, value ) {
                      $("[name='gropUser[]']").append('<option value="'+value["id"]+'">'+value["name"]+'</option>')
