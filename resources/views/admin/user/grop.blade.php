        ...
        <div class="col-12 mb-3">
            <div  class="card-box table-responsive">
                <div class="m-t-0 m-b-30">
                    ...
                    <h4 class="header-title d-inline-block ">فهرست لیست مجموعه کاربر {{$user["name"]}} {{$user["name2"]}}</h4>
                    <a href="/admin/user/grop/add/{{$user["id"]}}" class="btn btn-success btn-trans waves-effect w-md waves-success m-b-5 float-right">افزودن مجموعه</a>
                </div>
                                ...
                                @foreach($user_grops as $user_grop)
                                    ...
                                    <tr role="row" class="odd">
                                        ...
                                        <td style="display: none;" class="d-block-s">
                                            <button class="btn btn-danger btn-delete" id="{{$user_grop["id"]}}" name="{{$user_grop["usergrop"]["name"]}}" data-toggle="tooltip" data-placement="top" data-original-title="حذف" ><i class="fa fa-times"></i></button>
                                        </td>
                                    </tr>
                                    @endforeach
